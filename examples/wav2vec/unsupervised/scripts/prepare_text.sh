...
python $FAIRSEQ_ROOT/fairseq_cli/preprocess.py --dataset-impl mmap --trainpref $target_dir/lm.upper.lid.txt --only-source --destdir $target_dir --thresholdsrc 1 --padding-factor 1 --dict-only
...
#mkdir -p $target_dir/fst/phn_to_words_sil/
#mkdir -p $target_dir/fst/phn_to_words/
#mkdir -p $target_dir/fst/phn_to_phn/
